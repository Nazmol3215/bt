      ...
      <div className="container">
        ...
        <div className="row mb-4">
          <div className="col-md-12">
            <p>
              <FontAwesomeIcon icon={faPhone} /> <a href="tel:01641-131205" className="text-dark text-decoration-none">00641-00000</a>
            </p>
            <p>
              <FontAwesomeIcon icon={faEnvelope} /> <a href="mailto:bdtreehouse205@gmail.com" className="text-dark text-decoration-none">jdvhnurfdi@gmail.com</a>
            </p>
          </div>
        </div>
        ...
        <div className="row text-start">
          <div className="col-md-3 mb-4">
            ...
            <p className="text-muted">We are dedicated to transforming outdoor spaces into beautiful gardens that bring joy and peace.</p>
          </div>
          <div className="col-md-3 mb-4">
            <h5 className="fw-bold text-dark">Contact Us</h5>
            <p className="text-muted">Feel free to reach out to us for any gardening services or consultation.</p>
          </div>
          <div className="col-md-3 mb-4">
            <h5 className="fw-bold text-dark">Help & Support</h5>
            <p className="text-muted">Visit our FAQ section or chat with us for any support.</p>
          </div>
          <div className="col-md-3 mb-4">
            <h5 className="fw-bold text-dark">Our Brand</h5>
            <p className="text-muted">Garden Palace is trusted by nature lovers for unique and eco-friendly gardening solutions.</p>
          </div>
        </div>
